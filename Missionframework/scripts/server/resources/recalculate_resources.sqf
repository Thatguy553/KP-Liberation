...
while {true} do {
    ...
    {
        private _fob_buildings = _x nearobjects KP_liberation_FobRange;
    ...
    } forEach GRLIB_all_fobs;
    {
        ...
        _local_camp_resources pushBack [_x, _supplyValue, _ammoValue, _fuelValue, _hasAirBuilding, _hasRecBuilding];
        _local_supplies_global = _local_supplies_global + _supplyValue;
        _local_ammo_global = _local_ammo_global + _ammoValue;
        _local_fuel_global = _local_fuel_global + _fuelValue;
        _local_heli_slots = _local_heli_slots + _heliSlots;
    ...
    KP_liberation_camp_resources = _local_camp_resources;
