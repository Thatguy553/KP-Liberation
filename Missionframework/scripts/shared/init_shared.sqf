...
build_camp_remote_call = compileFinal preprocessFileLineNumbers "scripts\server\remotecall\build_camp_remote_call.sqf";
...
remote_call_camp = compileFinal preprocessFileLineNumbers "scripts\client\remotecall\remote_call_camp.sqf";
